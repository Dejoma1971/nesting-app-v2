  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ textAlign: 'center', maxWidth: '600px', padding: '0 20px' }}>
        <h1 style={{ fontSize: '3rem', margin: '0 0 10px 0', letterSpacing: '-1px' }}>
          Sistema de Nesting
        </h1>
      ...
      <div style={cardsContainerStyle}>
        ...
        >
          <div style={{ 
            ...
            marginBottom: '20px', color: theme.accentEng 
          }}>
          ...
          <h2 style={{ margin: '0 0 10px 0', color: theme.accentEng }}>Engenharia & Cadastro</h2>
          <p style={{ fontSize: '0.9rem', opacity: 0.8, lineHeight: '1.5' }}>
            Importe arquivos DXF, limpe geometrias, cadastre materiais e salve os pedidos no banco de dados.
          </p>
          <span style={{ marginTop: 'auto', paddingTop: '20px', fontSize: '0.85rem', fontWeight: 'bold', color: theme.accentEng }}>
            Iniciar Cadastro →
          </span>
        </div>
        ...
        >
          <div style={{ 
            width: '80px', height: '80px', background: 'rgba(40, 167, 69, 0.1)', 
            borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center',
            marginBottom: '20px', color: theme.accentNest 
          }}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <h2 style={{ margin: '0 0 10px 0', color: theme.accentNest }}>Mesa de Corte (Nesting)</h2>
          <p style={{ fontSize: '0.9rem', opacity: 0.8, lineHeight: '1.5' }}>
            Busque pedidos aprovados no banco, monte arranjos de corte otimizados e gere o arquivo final.
          </p>
          <span style={{ marginTop: 'auto', paddingTop: '20px', fontSize: '0.85rem', fontWeight: 'bold', color: theme.accentNest }}>
            Ir para Produção →
          </span>
        </div>
      ...
      <div style={{ position: 'absolute', bottom: 20, opacity: 0.3, fontSize: '0.8rem' }}>
