...
export const RegisterScreen: React.FC<RegisterScreenProps> = ({
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // --- LÓGICA DE REDIRECIONAMENTO INTELIGENTE (Mantida) ---
  ...
  const styles = {
    container: {
      ...
      background: "#1e1e1e",
      color: "#fff",
      position: "relative" as const, // Importante para o botão absoluto funcionar
    },
    form: {
      display: "flex",
      flexDirection: "column" as const,
    ...
    // ESTILO DO BOTÃO VOLTAR (Igual ao do Login)
    backButton: {
    ...
    <div style={styles.container}>
      ...
      <form onSubmit={handleRegister} style={styles.form}>
        ...
        <button
          type="submit"
          disabled={loading}
          style={{ ...styles.button, background: loading ? "#555" : "#28a745" }}
        >
